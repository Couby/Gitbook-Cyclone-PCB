This is the second part of the assembly process. You need to have built [the Y axis](https://github.com/carlosgs/Cyclone-PCB-Factory/wiki/Assembly-of-the-Y-axis) first.  
